...
export class PlayerList extends Component {
  ...
  toggleDealer(name) {
    ...
    if (currentDealer !== newDealer) {
      ...
      currrentStateData[
        currrentStateData.findIndex((el) => el._name === currentDealer._name)
      ] = { ...currentDealer, _dealer: false };
      currrentStateData[
        currrentStateData.findIndex((el) => el._name === newDealer._name)
      ] = { ...newDealer, _dealer: true };
  ...
  renderItem = ({ item, index, drag, isActive }) => {
    return (
      ...
      >
        ...
        <Ionicons
          name={item._dealer ? "ios-star" : "ios-star-outline"}
          size={25}
          onPress={() => {
